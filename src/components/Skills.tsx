              ...
              <div className="space-y-3">
                {category.skills.map((skill, skillIndex) => (
                  <motion.div
                    ...
                    className="bg-gradient-to-r from-purple-600/20 to-pink-600/20 p-3 rounded-lg border border-purple-500/30 text-center text-gray-300 hover:text-white transition-all duration-300"
                  >
                    {skill}
                  </motion.div>
                ))}
